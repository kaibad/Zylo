...
_This spins up a PostgreSQL 16 instance on port `5432` using the credentials defined in `docker-compose.yml`._
...
_The frontend application will be accessible at `http://localhost:3000`._
...
<table>
  ...
  <tr>
    <td><img src="https://ik.imagekit.io/sx7m1q6lm/zylo-project-kailash-badu-screenshots/zylo-frontend-local.webp" width="50%"></td>
    <td><img src="https://ik.imagekit.io/sx7m1q6lm/zylo-project-kailash-badu-screenshots/zylo-backend-local.webp" width="50%"></td>
  </tr>
</table>
